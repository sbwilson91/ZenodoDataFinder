"""
utils/md_to_html_email.py
Called from GitHub Actions as: python utils/md_to_html_email.py <input.md>
...
def build_html(md):
    ...
    return (
        ...
        f'<div class="title">bioRxiv Preprint Digest</div>'
        f'<div class="date">{date_str}</div>'
        '</div>'
        + body +
        '<div class="footer">Generated automatically &middot; bioRxiv preprints &middot; '
        'Filtered by user-defined watchlist</div>'
        '</div></body></html>'
    )
